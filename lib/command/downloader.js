...
_*Pencarian Ditemukan*_\n\n`
            ...
            // return await client.reply(msg, captions + `*Kyy Kurosakibot*`)

            await client.sendAdReply(msg.from, { text: captions + `*Kyy Kurosakibot*` }, { title: ytsr.title, description: config.botname, matchedText: ytsr[0].url, canonicalUrl: global.linkgcme, thumbnail: ytsr[0].thumbnail, previewType: 2, renderLargerThumbnail: true, mediaType: 1 })
...
*${config.botname}*`
                ...
                let filename = "Convert By: Kyy Kurosakibot" + data.title
...
*${config.botname}*`
                    ...
                    return client.sendAdReply(msg, { document: data.download.replace("https://", "http://"), fileName: filename }, { title: data.title, body: data.type + ` || ` + data.quality + ` || ` + data.filesize, thumbnail: data.thumb, mediaType: 1, mediaUrl: urls[0], sourceUrl: urls[0] })
                ...
                return client.sendAdReply(msg, { document: data.download.replace("https://", "http://"), fileName: filename }, { title: data.title, body: data.type + ` || ` + data.quality + ` || ` + data.filesize, thumbnail: play.result[0].thumbnail, mediaType: 1, mediaUrl: sul, sourceUrl: sul })
...
*${config.botname}*`
                ...
                return client.sendAdReply(msg, { audio: data.download.replace("https://", "http://"), fileName: filename }, { title: data.title, body: data.type + ` || ` + data.quality + ` || ` + data.filesize, thumbnail: data.thumb, mediaType: 1, mediaUrl: urls[0], sourceUrl: urls[0] })
  ...
  Data Berhasil Didapatkan:\n`
            ...
            await client.sendAdReply(msg, { audio: data.download.replace("https://", "http://"), fileName: filename }, { title: data.title, body: data.type + ` || ` + data.quality + ` || ` + data.filesize, thumbnail: play.result[0].thumbnail, mediaType: 1, mediaUrl: sul, sourceUrl: sul })
    ...
    if (command == "play" || command == "lagu" || command == "song") {
        ...
        try {
            ...
            await client.sendAdReply(msg, { audio: data.download.replace("https://", "http://"), fileName: filename }, { title: data.title, body: data.type + ` || ` + data.quality + ` || ` + data.filesize, thumbnail: play.result[0].thumbnail, mediaType: 2, mediaUrl: sul, sourceUrl: sul })
...
*Coments:* ${data.stats.commentCount? `${data.stats.commentCount}` : ``}
...
*${config.botname}*`
            ...
            await client.sendButton(msg, { video: data.video.noWatermark, caption: caption, footer: `Tik-tok Downloader Kyy Kurosakibot` }, [{ reply: "Audio", value: `.ttaudio ${urls[0]}` }])
...
*Share:* ${data.stats.shareCount? `${data.stats.shareCount}` : ``}

*Views:* ${data.stats.playCount? `${data.stats.playCount}` : ``}

*Duration:* ${data.video.duration? `${data.video.duration}` : ``} _Second_

*Quality:* ${data.video.ratio? `${data.video.ratio}` : ``}
...
cmd.on(['zippy', 'zippydl', 'zippyshare', 'zippysharedl', 'zippysharedownloader'], ['download'], async (msg, {
    ...
    try {
        ...
        return client.sendAdReply(msg, { document: res.result.download, fileName: res.result.name, caption: `*ZippyShare Downloader*\n\n*Title:* ${res.result.name}\n*Size*: ${res.result.size}\n*Uploadded:* ${res.result.upload} \n\n *Kyy Kurosakibot*` }, { title: res.result.name, body: res.result.size + "||" + res.result.upload, thumbnail: config.mecha_image, mediaType: 1, mediaUrl: "https://Instagram.com/sgt_prstyo", sourceUrl: "https://Instagram.com/sgt_prstyo" })
...
cmd.on(['gdrive', 'gdrivedl', 'googledrive', 'googledrivedl', 'googledrivedownloader'], ['download'], async (msg, {
    ...
    try {
        ...
        return client.sendAdReply(msg, { document: res.result.download, fileName: res.result.name, mimetype: res.result.mimetype, caption: `*Google Drive Downloader*\n\n*Title:* ${res.result.name}\n*Size*: ${res.result.size} \n\n *Kyy Kurosakibot*` }, { title: res.result.name, body: res.result.size, thumbnail: config.mecha_image, mediaType: 1, mediaUrl: "https://www.instagram.com/sgt_prstyo", sourceUrl: "https://www.instagram.com/sgt_prstyo" })
...
`
        ...
        client.reply(msg, { image: res[0].thumb, caption: captions + `*Kyy Kurosakibot*` })
...
// _Tunggu Sebentar Kyy Kurosakibot Sedang Menggirim File_
